...
Over 2mins per network is too much, why does it take time to converge?
...
class = c("ER", "PA", "SW") |> as_factor() # PA: preferential attachment, SW small world
dens = c(0.05, 0.1, 0.3, 0.5) |> as_factor()
delta = c("low", "high") |> as_factor()

exp_design <- tibble(
    treatment = interaction(n_size, class, dens, delta, sep = "_") |> levels()
) |> 
    separate(treatment, into = c("n_size", "class", "dens", "delta"), sep = "_")
